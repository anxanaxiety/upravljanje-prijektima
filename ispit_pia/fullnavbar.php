  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse align-middle" id="toggle">
      <ul class="navbar-nav d-flex align-items-center">
        <li class="nav-item mx-3 tekst-svetla2">
          <a href="#" class="tekst-svetla2">Svi projekti</a>
        </li>
        <li class="nav-item mx-3 tamna-glavna d-none">
          Kalendar
        </li>
        <li class="nav-item mx-3">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              ...
              <li><a class="dropdown-item" href="tema.php?id=4">Svetla</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item mx-3 p-2 prijavi-se d-none">
          Dnevni plan
        </li>
        <?php
