        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-md-8 col-lg-4 d-flex align-items-center justify-content-center my-5 flex-column">
                ...
                <div class="login-prozor p-5 w-100">
                    <h5 class="text-center naslov-prijava-registracija">Uspesna registracija, preusmeravam na login stranicu...</h5>
                    <p>ako ne radi preusmeravanje, <a href="login.php">kliknite ovde</a></p>
                    <?php
